            ...
            <form>
                <fieldset>
                    <div class="form-group">
                        <input class="form-control" placeholder="Peso em kg" name="peso" type="text">
                        <br>
                        <input class="form-control" placeholder="Altura em metros" name="altura" type="text">
                    </div>
